...
use langgraph_core::{StateGraph, GraphResult, ExecutionContext, START, END, LangGraphError};
use serde::{Serialize, Deserialize};

#[derive(Debug, Clone, Serialize, Deserialize)]
struct LoopState { n: u32 }

async fn loop_node(mut s: LoopState, _ctx: ExecutionContext) -> GraphResult<LoopState> {
